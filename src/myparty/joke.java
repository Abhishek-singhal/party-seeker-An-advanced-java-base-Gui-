...
//    nameList[i] = jsonArray.getJSONObject(i).getJSONObject("restaurant").getString("name");
    ...
    class Renderer extends DefaultTableCellRenderer
    {
        ...
        ImageIcon[] images = {new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/i.jpg"),new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/b.jpg"),new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/d.jpg"),new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/c.jpg"),new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/e.jpg"),new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/f.jpg"),new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/g.jpg"),new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/h.jpg"),new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/j.jpg"),new ImageIcon("/root/NetBeansProjects/MyParty/src/myparty/c.jpg")};       
        @Override
